...
export class ImportRowIdentity {
  private constructor(readonly parts: readonly ColumnValue[]) {}
  ...
  append(...parts: readonly ColumnValue[]): ImportRowIdentity {
    return new ImportRowIdentity([...this.parts, ...parts]);
  }

  appendIdentity(identity: ImportRowIdentity): ImportRowIdentity {
    return new ImportRowIdentity([...this.parts, ...identity.parts]);
  }
